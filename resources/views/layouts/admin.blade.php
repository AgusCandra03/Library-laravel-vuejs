    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <span class="badge badge-warning navbar-badge">{{ DB::table('notifications')->count() }}</span>
        </a>
        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-right">
          {{-- <span class="dropdown-item dropdown-header">
            {{ DB::table('notifications')->count() }} Notifications
          </span> --}}
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            {{-- <ul href="#" class="dropdown-item" id="message"> --}}
              {{-- <i class="fas fa-envelope mr-2" id="message"> </i> --}}
              {{-- Notifikasi melewati batas waktu --}}
              @php
                  // $notification = App\Models\Notification::all();
                  $notification = App\Models\Notification::with('members')
              ...
              @foreach ($notification as $notifications)
                <ul href="#" class="dropdown-item" id="message">
                  {{ $notifications->members->name }} {{ $notifications->message }} {{ $notifications->lama_telat }} hari
                </ul>
              @endforeach
